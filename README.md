  ...
  <div class="content">
    ...
    <section id="panel-req" hidden>
      <div class="list">
        ...
        <div class="row"><div><div class="label">Дата рождения</div><div class="value"><input id="dob" type="date"></div></div><button class="copy" data-copy="dob"><svg viewBox="0 0 24 24" fill="none"><rect x="9" y="9" width="11" height="11" rx="2" stroke-width="2"/><rect x="4" y="4" width="11" height="11" rx="2" stroke-width="2"/></svg></button></div>
        ...
        <div class="row"><div><div class="label">Дата выдачи</div><div class="value"><input id="issued" type="date"></div></div><button class="copy" data-copy="issued"><svg viewBox="0 0 24 24" fill="none"><rect x="9" y="9" width="11" height="11" rx="2" stroke-width="2"/><rect x="4" y="4" width="11" height="11" rx="2" stroke-width="2"/></svg></button></div>
        <div class="row"><div><div class="label">Срок действия</div><div class="value"><input id="expiry" type="date"></div></div><button class="copy" data-copy="expiry"><svg viewBox="0 0 24 24" fill="none"><rect x="9" y="9" width="11" height="11" rx="2" stroke-width="2"/><rect x="4" y="4" width="11" height="11" rx="2" stroke-width="2"/></svg></button></div>
      </div>
    </section>
  </div>
  <div class="footer">
